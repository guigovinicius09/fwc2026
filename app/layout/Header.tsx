...
import { Home, Users, Calendar, MapPin, Menu } from "lucide-react";
        ...
        <header className="sticky top-0 z-50 w-full transition-all duration-300">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8 font-noto text-sm">
                    <Link href="/" className="flex items-center gap-2 text-gray-300 hover:text-white transition-all duration-300 group">
                    ...
                    <Link href="/matches" className="flex items-center gap-2 text-gray-300 hover:text-white transition-all duration-300 group">
                        <Calendar size={18} className="group-hover:text-blue-400 transition-colors" />
                        <span className="relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-blue-500 group-hover:after:w-full after:transition-all after:duration-300">
                            Partidas
                        </span>
                    </Link>
                    
                    <Link href="/stadiums" className="flex items-center gap-2 text-gray-300 hover:text-white transition-all duration-300 group">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="md:hidden p-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors">
                        <Menu size={24} />
                    </button>
                </div>
